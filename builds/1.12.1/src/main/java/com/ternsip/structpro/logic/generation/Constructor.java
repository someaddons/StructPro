...
public abstract class Constructor {
    ...
    public static Projection calibrate(UWorld uWorld, int worldX, int worldZ, long seed, Structure candidate) throws IOException {
        ...
        candidate.matchBiome(Biomus.valueOf(uWorld.getBiome(new UBlockPos(posture.getPosX(), posture.getPosY(), posture.getPosZ()))));
        Region surface = new Region(uWorld, posture.getPosX(), posture.getPosZ(), posture.getSizeX(), posture.getSizeZ(), OVERLOOK);
        Region bottom = new Region(uWorld, posture.getPosX(), posture.getPosZ(), posture.getSizeX(), posture.getSizeZ(), HEAT_RAY);
        ...
        return new Projection(uWorld, candidate, posture, random.nextLong());
    }
     ...
     */
    public static Projection construct(UWorld uWorld, int worldX, int worldZ, long seed, Structure structure) {
        try {
            return calibrate(uWorld, worldX, worldZ, seed, structure);
