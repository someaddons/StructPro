...
import com.ternsip.structpro.universe.blocks.Directions;
...
public class Posture extends Volume {
     ...
     */
    UBlockPos getWorldPos(int index) {
     ...
     */
    UBlockPos getVolumePos(int wx, int wy, int wz) {
        int x = wx - posX;
        int y = wy - posY;
        int z = wz - posZ;
        int w = getWidth(), h = getHeight(), l = getLength();
