    ...
    */
    ...
    public static void setTileTag(World world, BlockPos pos, NBTTagCompound tile) {
        ...
        try {
            ...
            Class <? extends TileEntity> tileClass = net.minecraftforge.fml.common.registry.GameData.getTileEntityRegistry().getObject(new ResourceLocation(s));
            if (tileClass != null) {
                tileClass.newInstance().readFromNBT(tag);
            } else {
                throw new Throwable("No tile with id: " + s);
            }
